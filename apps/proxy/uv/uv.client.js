...
(() => {
    ...
    var ze = (a, e, r, t) => {
        if (e && typeof e == "object" || typeof e == "function")
            for (let o of Ke(e)) !Xe.call(a, o) && o !== r && B(a, o, {
                get: () => e[o],
                enumerable: !(t = Be(e, o)) || t.enumerable
            });
        return a
    };
    var p = (a, e, r) => (r = a != null ? Ge($e(a)) : {}, ze(e || !a || !a.__esModule ? B(r, "default", {
        value: a,
        enumerable: !0
    }) : r, a));
    var d = Qe((st, x) => {
        ...
        var m = typeof Reflect == "object" ? Reflect : null,
            K = m && typeof m.apply == "function" ? m.apply : function(e, r, t) {
        ...
        Object.defineProperty(c, "defaultMaxListeners", {
            ...
            set: function(a) {
                if (typeof a != "number" || a < 0 || X(a)) throw new RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' + a + ".");
                $ = a
            }
        });
        c.init = function() {
        ...
        c.prototype.setMaxListeners = function(e) {
            if (typeof e != "number" || e < 0 || X(e)) throw new RangeError('The value of "n" is out of range. It must be a non-negative number. Received ' + e + ".");
        ...
        c.prototype.emit = function(e) {
            ...
            if (typeof h == "function") K(h, this, r);
                ...
                for (var u = h.length, f = ee(h, u), t = 0; t < u; ++t) K(f[t], this, r);
            return !0
        };

        function z(a, e, r, t) {
            var o, i, n;
            if (y(r), i = a._events, i === void 0 ? (i = a._events = Object.create(null), a._eventsCount = 0) : (i.newListener !== void 0 && (a.emit("newListener", e, r.listener ? r.listener : r), i = a._events), n = i[e]), n === void 0) n = i[e] = r, ++a._eventsCount;
            else if (typeof n == "function" ? n = i[e] = t ? [r, n] : [n, r] : t ? n.unshift(r) : n.push(r), o = Q(a), o > 0 && n.length > o && !n.warned) {
                n.warned = !0;
                ...
                l.name = "MaxListenersExceededWarning", l.emitter = a, l.type = e, l.count = n.length, Je(l)
            }
            return a
        }
        ...
        c.prototype.removeListener = function(e, r) {
            ...
            if (t === r || t.listener === r) --this._eventsCount === 0 ? this._events = Object.create(null) : (delete o[e], o.removeListener && this.emit("removeListener", e, t.listener || r));
                ...
                i === 0 ? t.shift() : Ze(t, i), t.length === 1 && (o[e] = t[0]), o.removeListener !== void 0 && this.emit("removeListener", e, l || r)
            }
            return this
        };
        ...
        c.prototype.removeAllListeners = function(e) {
            ...
            if (arguments.length === 0) {
                var i = Object.keys(t),
                    n;
                for (o = 0; o < i.length; ++o) n = i[o], n !== "removeListener" && this.removeAllListeners(n);
        ...
        function et(a) {
            for (var e = new Array(a.length), r = 0; r < e.length; ++r) e[r] = a[r].listener || a[r];
            return e
        }
        ...
        function tt(a, e) {
            return new Promise(function(r, t) {
                ...
                function i() {
                    typeof a.removeListener == "function" && a.removeListener("error", o), r([].slice.call(arguments))
                }
                te(a, e, i, {
                    once: !0
                }), e !== "error" && rt(a, o, {
        ...
        function te(a, e, r, t) {
            ...
            else if (typeof a.addEventListener == "function") a.addEventListener(e, function o(i) {
    ...
    var S = class {
            ...
            constructor(e = {}, r = null, t = null) {
                this.#e = !1, this.#t = null, this.data = e, this.target = r, this.that = t
            }
            get intercepted() {
                return this.#e
            }
    ...
    var E = class extends re.default {
            ...
            overrideQuerySelector() {
                this.ctx.override(this.docProto, "querySelector", (e, r, t) => {
                    ...
                    return this.emit("querySelector", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.selectors)
                })
            }
            overrideDomain() {
                this.ctx.overrideDescriptor(this.docProto, "domain", {
                    get: (e, r) => {
                        ...
                        return this.emit("getDomain", t), t.intercepted ? t.returnValue : t.data.value
                    },
                    set: (e, r, [t]) => {
                        let o = new s({
                            value: t
            ...
            overrideReferrer() {
                this.ctx.overrideDescriptor(this.docProto, "referrer", {
                    get: (e, r) => {
                        ...
                        return this.emit("referrer", t), t.intercepted ? t.returnValue : t.data.value
                    }
                })
            }
            overrideCreateTreeWalker() {
                this.ctx.override(this.docProto, "createTreeWalker", (e, r, t) => {
                    if (!t.length) return e.apply(r, t);
                    let [o, i = 4294967295, n, l] = t, h = new s({
                        root: o,
                        show: i,
                        filter: n,
            ...
            overrideWrite() {
                this.ctx.override(this.docProto, "write", (e, r, t) => {
                    ...
                    return this.emit("write", i), i.intercepted ? i.returnValue : i.target.apply(i.that, i.data.html)
                }), this.ctx.override(this.docProto, "writeln", (e, r, t) => {
                    if (!t.length) return e.apply(r, t);
                    let [...o] = t, i = new s({
                        html: o
                    }, e, r);
                    return this.emit("writeln", i), i.intercepted ? i.returnValue : i.target.apply(i.that, i.data.html)
                })
            }
            overrideDocumentURI() {
                this.ctx.overrideDescriptor(this.docProto, "documentURI", {
                    get: (e, r) => {
                        ...
                        return this.emit("documentURI", t), t.intercepted ? t.returnValue : t.data.value
                    }
                })
            }
            overrideURL() {
                this.ctx.overrideDescriptor(this.docProto, "URL", {
                    get: (e, r) => {
                        ...
                        return this.emit("url", t), t.intercepted ? t.returnValue : t.data.value
                    }
                })
            }
            overrideCookie() {
                this.ctx.overrideDescriptor(this.docProto, "cookie", {
                    get: (e, r) => {
                        ...
                        return this.emit("getCookie", t), t.intercepted ? t.returnValue : t.data.value
                    },
                    set: (e, r, [t]) => {
                        let o = new s({
                            value: t
            ...
            overrideTitle() {
                this.ctx.overrideDescriptor(this.docProto, "title", {
                    get: (e, r) => {
                        ...
                        return this.emit("getTitle", t), t.intercepted ? t.returnValue : t.data.value
                    },
                    set: (e, r, [t]) => {
                        let o = new s({
                            value: t
    ...
    var O = class extends oe.default {
            ...
            overrideAttribute() {
                this.ctx.override(this.elemProto, "getAttribute", (e, r, t) => {
                    ...
                    return this.emit("getAttribute", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
                    ...
                    return this.emit("hasAttribute", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
                }), this.ctx.override(this.elemProto, "removeAttribute", (e, r, t) => {
                    if (!t.length) return e.apply(r, t);
                    let [o] = t, i = new s({
                        name: o
                    }, e, r);
                    return this.emit("removeAttribute", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
                })
            }
            overrideAudio() {
                this.ctx.override(this.window, "Audio", (e, r, t) => {
                    ...
                    return this.emit("audio", i), i.intercepted ? i.returnValue : new i.target(i.data.url)
                }, !0)
            }
            overrideHtml() {
                this.hookProperty(this.Element, "innerHTML", {
                    get: (e, r) => {
                        ...
                        return this.emit("getInnerHTML", t), t.intercepted ? t.returnValue : t.data.value
                    },
                    set: (e, r, [t]) => {
                        let o = new s({
                            value: t
                    ...
                    get: (e, r) => {
                        ...
                        return this.emit("getOuterHTML", t), t.intercepted ? t.returnValue : t.data.value
                    },
                    set: (e, r, [t]) => {
                        let o = new s({
                            value: t
    ...
    var M = class extends se.default {
            ...
            overrideTextContent() {
                this.ctx.overrideDescriptor(this.nodeProto, "textContent", {
                    get: (e, r) => {
                        ...
                        return this.emit("getTextContent", t), t.intercepted ? t.returnValue : t.data.value
                    },
                    set: (e, r, [t]) => {
                        let o = new s({
                            value: t
            ...
            overrideAppend() {
                this.ctx.override(this.nodeProto, "append", (e, r, [...t]) => {
                    ...
                    return this.emit("appendChild", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.node)
                })
            }
            overrideBaseURI() {
                this.ctx.overrideDescriptor(this.nodeProto, "baseURI", {
                    get: (e, r) => {
                        ...
                        return this.emit("baseURI", t), t.intercepted ? t.returnValue : t.data.value
                    }
                })
            }
            overrideParent() {
                this.ctx.overrideDescriptor(this.nodeProto, "parentNode", {
                    get: (e, r) => {
                        ...
                        return this.emit("parentNode", t), t.intercepted ? t.returnValue : t.data.node
                    }
                    ...
                    get: (e, r) => {
                        ...
                        return this.emit("parentElement", t), t.intercepted ? t.returnValue : t.data.node
                    }
                })
            }
            overrideOwnerDocument() {
                this.ctx.overrideDescriptor(this.nodeProto, "ownerDocument", {
                    get: (e, r) => {
                        ...
                        return this.emit("ownerDocument", t), t.intercepted ? t.returnValue : t.data.document
                    }
                })
            }
    ...
    var L = class extends le.default {
            ...
            overrideNameValue() {
                this.ctx.overrideDescriptor(this.attrProto, "name", {
                    get: (e, r) => {
                        ...
                        return this.emit("name", t), t.intercepted ? t.returnValue : t.data.value
                    }
                    ...
                    get: (e, r) => {
                        ...
                        return this.emit("getValue", t), t.intercepted ? t.returnValue : t.data.value
                    },
                    set: (e, r, [t]) => {
                        let o = new s({
                            name: this.name.get.call(r),
            ...
            overrideItemMethods() {
                this.ctx.override(this.attrProto, "getNamedItem", (e, r, t) => {
                    ...
                    return this.emit("getNamedItem", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
                    ...
                    return this.emit("removeNamedItem", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
                }), this.ctx.override(this.attrProto, "item", (e, r, t) => {
                    if (!t.length) return e.apply(r, t);
                    let [o] = t, i = new s({
                        index: o
                    }, e, r);
                    return this.emit("item", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
                    ...
                    return this.emit("setNamedItemNS", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
    ...
    var k = class extends ue.default {
            ...
            overrideToString() {
                this.ctx.override(this.fnProto, "toString", (e, r) => {
                    ...
                    return this.emit("toString", t), t.intercepted ? t.returnValue : t.target.call(t.data.fn)
                })
            }
        },
        ce = k;
    ...
    var D = class extends de.default {
            ...
            overrideGetPropertyNames() {
                this.ctx.override(this.Object, "getOwnPropertyNames", (e, r, t) => {
                    ...
                    return this.emit("getOwnPropertyNames", i), i.intercepted ? i.returnValue : i.data.names
                })
            }
            overrideGetOwnPropertyDescriptors() {
                this.ctx.override(this.Object, "getOwnPropertyDescriptors", (e, r, t) => {
                    ...
                    return this.emit("getOwnPropertyDescriptors", i), i.intercepted ? i.returnValue : i.data.descriptors
                })
            }
        },
        pe = D;
    ...
    var N = class extends fe.default {
            ...
            overrideRequest() {
                return this.fetch ? (this.ctx.override(this.window, "fetch", (e, r, t) => {
                    if (!t.length || t[0] instanceof this.Request) return e.apply(r, t);
                    let [o, i = {}] = t, n = new s({
                        input: o,
                        options: i
                    }, e, r);
            ...
            overrideUrl() {
                return this.ctx.overrideDescriptor(this.reqProto, "url", {
                    get: (e, r) => {
                        ...
                        return this.emit("requestUrl", t), t.intercepted ? t.returnValue : t.data.value
                    }
                    ...
                    get: (e, r) => {
                        ...
                        return this.emit("responseUrl", t), t.intercepted ? t.returnValue : t.data.value
                    }
                }), !0
            }
            overrideHeaders() {
                return this.Headers ? (this.ctx.overrideDescriptor(this.reqProto, "headers", {
                    get: (e, r) => {
                        ...
                        return this.emit("requestHeaders", t), t.intercepted ? t.returnValue : t.data.value
                    }
                    ...
                    get: (e, r) => {
                        ...
                        return this.emit("responseHeaders", t), t.intercepted ? t.returnValue : t.data.value
                    }
                    ...
                    return this.emit("hasHeader", i), i.intercepted ? i.returnValue : i.data
                    ...
                    return this.emit("deleteHeader", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
                }), !0) : !1
            }
        },
        me = N;
    ...
    var R = class extends ve.default {
            ...
            overrideOpen() {
                this.ctx.override(this.xhrProto, "open", (e, r, t) => {
                    if (2 > t.length) return e.apply(r, t);
                    let [o, i, n = !0, l = null, h = null] = t, u = new s({
                        method: o,
                        input: i,
                        async: n,
                        user: l,
                    ...
                    return this.emit("open", u), u.intercepted ? u.returnValue : u.target.call(u.that, u.data.method, u.data.input, u.data.async, u.data.user, u.data.password)
                })
            }
            overrideResponseUrl() {
            ...
            overrideGetResHeaders() {
                this.ctx.override(this.xhrProto, "getAllResponseHeaders", (e, r) => {
                    ...
                    return this.emit("getAllResponseHeaders", t), t.intercepted ? t.returnValue : t.data.value
                })
            }
    ...
    var C = class extends ge.default {
            ...
            overridePushState() {
                this.ctx.override(this.historyProto, "pushState", (e, r, t) => {
                    ...
                    return this.emit("pushState", l), l.intercepted ? l.returnValue : l.target.call(l.that, l.data.state, l.data.title, l.data.url)
                })
            }
            overrideReplaceState() {
                this.ctx.override(this.historyProto, "replaceState", (e, r, t) => {
                    ...
                    return this.emit("replaceState", l), l.intercepted ? l.returnValue : l.target.call(l.that, l.data.state, l.data.title, l.data.url)
                })
            }
            overrideGo() {
            ...
            overrideForward() {
                this.ctx.override(this.historyProto, "forward", (e, r) => {
                    ...
                    return this.emit("forward", t), t.intercepted ? t.returnValue : t.target.call(t.that)
                })
            }
            overrideBack() {
                this.ctx.override(this.historyProto, "back", (e, r) => {
                    let t = new s(null, e, r);
                    return this.emit("back", t), t.intercepted ? t.returnValue : t.target.call(t.that)
                })
            }
        },
        be = C;
    var xe = p(d(), 1),
        I = class extends xe.default {
            ...
            overrideWorkerLocation(e) {
                ...
                let r = this;
                for (let t of this.keys) this.ctx.overrideDescriptor(this.workerLocProto, t, {
            ...
            emulate(e, r) {
                let t = {},
                    o = this;
                for (let i of o.keys) this.ctx.nativeMethods.defineProperty(t, i, {
                    get() {
                ...
                return "reload" in this.location && this.ctx.nativeMethods.defineProperty(t, "reload", {
                    ...
                    get() {
                        let i = [];
                        return o.window.DOMStringList && o.ctx.nativeMethods.setPrototypeOf(i, o.window.DOMStringList.prototype), i
                    },
                    set: void 0,
                    enumerable: !0
                    ...
                    writable: !1,
                    enumerable: !1
                }), this.ctx.window.Location && this.ctx.nativeMethods.setPrototypeOf(t, this.ctx.window.Location.prototype), t
            }
        },
        Se = I;
    var Ee = p(d(), 1);
    var T = class extends Ee.default {
            ...
            overridePostMessage() {
                this.ctx.override(this.window, "postMessage", (e, r, t) => {
                    ...
                    return this.emit("postMessage", l), l.intercepted ? l.returnValue : this.ctx.worker ? l.target.call(l.that, l.data.message, l.data.transfer) : l.target.call(l.that, l.data.message, l.data.origin, l.data.transfer)
                })
            }
            wrapPostMessage(e, r, t = !1) {
                return this.ctx.wrap(e, r, (o, i, n) => {
                    ...
                    return this.emit("postMessage", f), f.intercepted ? f.returnValue : t ? f.target.call(f.that, f.data.message, f.data.transfer) : f.target.call(f.that, f.data.message, f.data.origin, f.data.transfer)
                })
            }
            overrideMessageOrigin() {
                this.ctx.overrideDescriptor(this.messageProto, "origin", {
                    get: (e, r) => {
                        ...
                        return this.emit("origin", t), t.intercepted ? t.returnValue : t.data.value
                    }
                })
            }
            overrideMessageData() {
                this.ctx.overrideDescriptor(this.messageProto, "data", {
                    get: (e, r) => {
                        ...
                        return this.emit("data", t), t.intercepted ? t.returnValue : t.data.value
                    }
                })
            }
        },
    ...
    async function A() {
        ...
        try {
            ...
            if (t instanceof AggregateError) throw console.error("bare-mux: failed to get a bare-mux SharedWorker MessagePort as all clients returned an invalid MessagePort."), new Error("All clients returned an invalid MessagePort.");
            return console.warn("bare-mux: failed to get a bare-mux SharedWorker MessagePort within 1s, retrying"), await A()
        }
    }
    ...
    var U = class {
        constructor(e) {
            this.channel = new BroadcastChannel("bare-mux"), e instanceof MessagePort ? this.port = e : this.createChannel(e, !0)
        }
        createChannel(e, r) {
            if (self.clients) this.port = A(), this.channel.onmessage = t => {
                ...
                this.port = De(e, r), console.debug("bare-mux: setting localStorage bare-mux-path to", e), ke["bare-mux-path"] = e
            } else if (P) {
                let t = ke["bare-mux-path"];
                if (console.debug("bare-mux: got localStorage bare-mux-path:", t), !t) throw new Error("Unable to get bare-mux workerPath from localStorage.");
                this.port = De(t, r)
        ...
        async sendMessage(e, r) {
            ...
            try {
                ...
                return console.warn("bare-mux: Failed to get a ping response from the worker within 1.5s. Assuming port is dead."), this.createChannel(), await this.sendMessage(e, r)
            }
    ...
    var j = class extends Ce.default {
            ...
            overrideObjectURL() {
                this.ctx.override(this.URL, "createObjectURL", (e, r, t) => {
                    ...
                    return this.emit("createObjectURL", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.object)
                }), this.ctx.override(this.URL, "revokeObjectURL", (e, r, t) => {
                    if (!t.length) return e.apply(r, t);
                    let [o] = t, i = new s({
                        url: o
                    }, e, r);
                    return this.emit("revokeObjectURL", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.url)
                })
            }
        },
        Ie = j;
    ...
    var q = class extends Te.default {
            ...
            overrideMethods() {
                this.ctx.override(this.storeProto, "getItem", (e, r, t) => {
                    ...
                    return this.emit("getItem", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
                    ...
                    return this.emit("removeItem", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
                }), this.ctx.override(this.storeProto, "clear", (e, r) => {
                    let t = new s(null, e, this.wrappers.get(r) || r);
                    return this.emit("clear", t), t.intercepted ? t.returnValue : t.target.call(t.that)
                }), this.ctx.override(this.storeProto, "key", (e, r, t) => {
                    if (!t.length) return e.apply(this.wrappers.get(r) || r, t);
                    let [o] = t, i = new s({
                        index: o
                    }, e, this.wrappers.get(r) || r);
                    return this.emit("key", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.index)
                })
            }
            overrideLength() {
                this.ctx.overrideDescriptor(this.storeProto, "length", {
                    get: (e, r) => {
                        ...
                        return this.emit("length", t), t.intercepted ? t.returnValue : t.data.length
                    }
                })
            }
            emulate(e, r = {}) {
                ...
                let t = new this.ctx.window.Proxy(r, {
                    get: (o, i) => {
                        ...
                        return this.emit("get", n), n.intercepted ? n.returnValue : e[n.data.name]
                    },
                    set: (o, i, n) => {
                        ...
                        return this.emit("set", l), l.intercepted ? l.returnValue : e[l.data.name] = l.data.value
                    },
                    deleteProperty: (o, i) => {
                        ...
                        return this.emit("delete", n), n.intercepted ? n.returnValue : delete e[n.data.name]
                    }
                });
                return this.wrappers.set(t, e), this.ctx.nativeMethods.setPrototypeOf(t, this.storeProto), t
            }
        },
        He = q;
    var Ae = p(d(), 1);
    var _ = class extends Ae.default {
            ...
            overrideSetGetProperty() {
                this.ctx.override(this.cssStyleProto, "getPropertyValue", (e, r, t) => {
                    ...
                    return this.emit("getPropertyValue", i), i.intercepted ? i.returnValue : i.target.call(i.that, i.data.property)
            ...
            overrideCssText() {
                this.ctx.overrideDescriptor(this.cssStyleProto, "cssText", {
                    get: (e, r) => {
                        ...
                        return this.emit("getCssText", t), t.intercepted ? t.returnValue : t.data.value
                    },
                    set: (e, r, [t]) => {
                        let o = new s({
                            value: t
    ...
    var F = class extends We.default {
            constructor(e) {
                super(), this.ctx = e, this.window = this.ctx.window, this.IDBDatabase = this.window.IDBDatabase || {}, this.idbDatabaseProto = this.IDBDatabase.prototype || {}, this.IDBFactory = this.window.IDBFactory || {}, this.idbFactoryProto = this.IDBFactory.prototype || {}, this.open = this.idbFactoryProto.open
            }
            overrideOpen() {
            ...
            overrideName() {
                this.ctx.overrideDescriptor(this.idbDatabaseProto, "name", {
                    get: (e, r) => {
                        ...
                        return this.emit("idbFactoryName", t), t.intercepted ? t.returnValue : t.data.value
                    }
                })
            }
        },
    ...
    var b = class extends Fe.default {
            constructor(e = self, r, t = !e.window) {
                ...
                }, this.worker = t, this.bareClient = r, this.fetch = new me(this), this.xhr = new we(this), this.idb = new je(this), this.history = new be(this), this.element = new ne(this), this.node = new ae(this), this.document = new ie(this), this.function = new ce(this), this.object = new pe(this), this.websocket = new _e(this), this.message = new Oe(this), this.navigator = new Le(this), this.eventSource = new Pe(this), this.attribute = new he(this), this.url = new Ie(this), this.workers = new Ve(this), this.location = new Se(this), this.storage = new He(this), this.style = new Ue(this)
            }
            override(e, r, t, o) {
            ...
            wrap(e, r, t, o = !1) {
                ...
                return o && (n.prototype = i.prototype, n.prototype.constructor = n), this.emit("wrap", i, n, o), n
            }
            wrapDescriptor(e, r, t = {}) {
                let o = this.nativeMethods.getOwnPropertyDescriptor(e, r);
                if (!o) return !1;
                for (let i in t) i in o && (i === "get" || i === "set" ? o[i] = this.wrap(o, i, t[i]) : o[i] = typeof t[i] == "function" ? t[i](o[i]) : t[i]);
                return o
            }
        },
        vr = b;
